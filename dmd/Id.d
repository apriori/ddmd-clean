...
//  All this is now in dmd.Identifier!!!!!!!
...
//          FGAFAFGagdfsklfdkjdfashlkfjshfdalkjdhfs

// I rewrote the mixin code here
// I'm using the module's namespace instead of a struct
// import dmd.Id = Id; // The safest way...? 
...
// e.g. static Identifier Object_;
// e.g. static Identifier max;
mixin( generateIdents() );
static void initialize()
{
    // e.g Object_ = Lexer.idPool("Object");
    mixin( generateNames() );
}
...
private string generateNames()
{
    ...
    foreach ( id; IDS )
    {
        ...
        res ~= "\t" ~ id[0] ~ ` = Lexer.idPool("` ~ tmp ~ "\");\n";
    }
    return res;
}

private immutable string[2][] IDS = 
[
    [ "IUnknown", null ],
    [ "Object_", "Object" ],
